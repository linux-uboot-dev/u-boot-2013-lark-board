...
#else
#define CONFIG_BOOTCOMMAND "run mmcload; run fpgaload;run bridge_enable_handoff; run mmcboot"
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"fdtimage=socfpga_cyclone5.dtb\0" \
	...
	"ramload=fatload mmc 0:1 ${loadaddr} ${bootimage};" \
	 "fatload mmc 0:1 ${ramdiskaddr} ${ramdiskimage};" \
	 "fatload mmc 0:1 ${fdtaddr} ${fdtimage}\0" \
	"ramboot=setenv bootargs console=ttyS0,115200 root=/dev/ram rw rootfstype=ext2;"\
